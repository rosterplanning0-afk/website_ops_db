...
import { ClipboardCheck, Search, CloudUpload, Save, CheckCircle2, XCircle, CircleDashed, TrendingUp } from 'lucide-react'
...
export default function NewTOInspectionForm() {
    ...
    useEffect(() => {
        async function checkAuth() {
            try {
                ...
                if (allowedRoles.includes(userRole.toLowerCase()) || isLineInspector) {
