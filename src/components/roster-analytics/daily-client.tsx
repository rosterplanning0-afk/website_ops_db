...
export function DailyOverviewClient({ initialData, initialDate }: DailyOverviewClientProps) {
    ...
    // Sync selected date with URL when changed
    ...
    // Keep local selectedDate in sync if URL changes (e.g. back button)
    useEffect(() => {
