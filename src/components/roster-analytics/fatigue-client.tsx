...
interface FatigueClientProps {
    initialData: DailyRosterRow[]
    initialFromDate: string
    initialToDate: string
}

export function FatigueClient({ initialData, initialFromDate, initialToDate }: FatigueClientProps) {
    ...
    const crewTypes = useMemo(() => [...new Set(data.map(r => r.crew_type).filter(Boolean))] as string[], [data])
    ...
    }, [filteredData, initialFromDate, initialToDate])
            ...
            <Card>
                <CardContent className="pt-6">
                    <div className="flex flex-wrap gap-4 items-center">
                        ...
                        <p className="text-xs text-slate-400 ml-auto">(Date range changes update the server)</p>
                    </div>
                </CardContent>
            </Card>
                ...
                <Card className="bg-amber-50">
                    <CardContent className="pt-4 pb-4 flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-slate-500">Highest Range Hours</p>
                        </div>
                    </CardContent>
                </Card>
