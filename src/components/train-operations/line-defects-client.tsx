...
interface LineDefectsClientProps {
    initialDefects: LineDefect[]
    empId: string
    empName: string
    userId: string
}

export function LineDefectsClient({ initialDefects, empId, empName, userId }: LineDefectsClientProps) {
